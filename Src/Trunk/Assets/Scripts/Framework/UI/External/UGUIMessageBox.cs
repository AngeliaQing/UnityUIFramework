...
{
    /*
     * 利用UGUI做的MessageBox示例
     * 每个项目对于系统弹框可以做成自己的样式，但是一个项目最好规范成只做一种
     */
    public class UGUIMessageBox : UIMessageBox
    {

        public Text m_label_ok;
        public Text m_label_cancel;

        public Text m_label_title;
        ...
        //这个函数内的参数根据具体项目来定
        void SetButtonText(string text, Text label)
        {
            if (label == null)
                return;
